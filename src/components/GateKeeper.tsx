...
export default function GateKeeper({ onUnlock }: GateKeeperProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-[100dvh] bg-black text-green-500 font-mono p-4 relative overflow-hidden select-none">
      ...
      <div className="flex flex-col items-center max-w-sm w-full space-y-6 z-10">
        ...
        <div className="text-center space-y-2 mb-8">
          <h1 className="text-2xl font-bold tracking-widest text-green-400">EV OS</h1>
          <p className="text-sm text-green-700">EV CYBER ACADEMY - Restricted Access</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4">
          ...
          <button
            type="submit"
            className="w-full flex justify-center py-3 px-4 border border-zinc-800 rounded-md shadow-sm text-sm font-bold text-green-500 bg-zinc-900 hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-zinc-700 uppercase tracking-widest transition-colors mt-4"
          >
            Authenticate
          </button>
        </form>
